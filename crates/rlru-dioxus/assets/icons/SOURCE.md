...
desktop entries, tray pixmaps, and Android launcher assets. The generated PNGs
keep the icon canvas transparent; only the edge-connected white background from
the source render is removed.
